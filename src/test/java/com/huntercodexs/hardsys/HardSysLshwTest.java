...
import static com.huntercodexs.hardsys.command.HardSysCommands.LSHW;

@ExtendWith(MockitoExtension.class)
@MockitoSettings(strictness = Strictness.LENIENT)
public class HardSysLshwTest {

    @Test
    public void generalSystemInfoByLshwCommandTest() {

        HardSys hardSys = new HardSys(LSHW);
        hardSys.json();
        ...
        //--CONTROLLER
        HardSysControllerDetails controller = hardSys.resources().getController();
