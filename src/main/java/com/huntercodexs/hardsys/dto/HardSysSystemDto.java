...
public class HardSysSystemDto {

    private String qty;
    private List<HardSysSystem> details;

    public HardSysSystemDto() {
    ...
    public List<HardSysSystem> getDetails() {
        return details;
    }

    public void setDetails(List<HardSysSystem> details) {
        this.details = details;
    }

    public void addSystem(HardSysSystem system) {
        this.details.add(system);
    }

    public String toString() {
        return "HardSysSystemDto[" +
                "qty=" + qty +
                ", details=" + details +
                "]";
    }

    public static class HardSysSystem {
